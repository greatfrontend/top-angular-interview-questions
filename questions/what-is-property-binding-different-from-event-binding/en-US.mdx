...
- [Angular Documentation: Event Binding](https://angular.io/guide/event-binding)
- [Angular Documentation: Binding syntax overview](https://angular.io/guide/binding-syntax)
