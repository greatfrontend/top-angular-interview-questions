...
- [Angular Documentation: Architecture Overview](https://angular.dev/guide/architecture)
...
- [Angular Documentation: Data Binding](https://angular.dev/guide/concept-intro)
