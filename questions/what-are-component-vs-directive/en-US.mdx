...
- [Angular Documentation: Attribute Directives](https://angular.dev/guide/attribute-directives)
- [Angular Documentation: Structural Directives](https://angular.dev/guide/structural-directives)
