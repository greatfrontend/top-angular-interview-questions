...
- [Angular Documentation: View Encapsulation](https://angular.dev/style-guide/component-styles#view-encapsulation)
- [MDN Web Docs: Using Shadow DOM](https://developer.mozilla.org/en-US/docs/Web/API/Shadow_DOM_API/Using_shadow_DOM)
