...
- [Angular Documentation: Services and Dependency Injection](https://angular.dev/guide/dependency-injection)
- [Angular Documentation: Providing Dependencies](https://angular.dev/guide/dependency-injection/providing-dependencies)
